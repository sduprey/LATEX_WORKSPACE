	  ...
	  \newline 
	  \textbf{\textcolor{black}{\large What a genetic algorithm}}
	  \scriptsize{
	  ...
	  \newline \textbf{\textcolor{black}{\large Why a genetic algorithm}}
	  \scriptsize{
    ...
    \end{center}
	  ...
	  \begin{slide}
	    ...
	    \begin{center}
	    \epsfig{file=neo4j_maze_runner.eps,height=3cm,width=8cm}
	    \end{center}
	  \end{slide}
	  \end{document}